...
export const CRITERIA: Criterion[] = [
  ...
  },
  {
    ...
    note: "Larger populations = more patients touched per pilot rand. Real — 2022 census.",
    kind: "real",
    score: (d) => d.f_pop,
  },
  {
    key: "connectivity",
    label: "Connectivity",
    note: "Density used as a proxy for mobile coverage. Modelled — replace with SARA / network data.",
    kind: "modelled",
    score: (d) => d.f_density,
  },
  {
    ...
    note: "Closer to the Dar hub = cheaper supportive supervision. Real — geodesic distance.",
    kind: "real",
